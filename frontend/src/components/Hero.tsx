  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1766788467067-d443f19314b6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmR1c3RyaWFsJTIwYWlyJTIwY29uZGl0aW9uZXIlMjBmYWN0b3J5fGVufDF8fHx8MTc2ODM2MDM5MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          alt="Industrial air conditioning"
          className="w-full h-full object-cover"
        />
        {/* Gradient Overlay - Lighter for clearer image */}
